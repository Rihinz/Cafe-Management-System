...
while ($order = $res->fetch_object()) {
    $subtotal = $order->prod_price * $order->prod_qty; // Calculate subtotal
    $tax = $subtotal * 0.14; // Calculate 14% tax
            ...
            <div id="Receipt" class="well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
                <div class="row">
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        <address>
                            <strong>Giraffe Coffee</strong>
                            <br>
                            E1-02-11
                            <br>
                            Block E Level 2, Sunway GEO Avenue, Jalan Lagoon Selatan, Bandar Sunway,
                            <br>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="col-md-1 text-center"><?php echo $order->prod_qty; ?></td>
                                <td class="col-md-1 text-center">RM<?php echo number_format($order->prod_price, 2); ?></td>
                                <td class="col-md-1 text-center">RM<?php echo number_format($subtotal, 2); ?></td>
                            </tr>
                            <tr>
                                <td>   </td>
                                <td>   </td>
                                ...
                                <td class="text-center">
                                    <p><strong>RM<?php echo number_format($subtotal, 2); ?></strong></p>
                                    <p><strong>RM<?php echo number_format($tax, 2); ?></strong></p>
                                </td>
                            </tr>
                            <tr>
                                <td>   </td>
                                ...
                                <td class="text-center text-danger">
                                    <h4><strong>RM<?php echo number_format($total, 2); ?></strong></h4>
                                </td>
                            </tr>
                        </tbody>
                    </table>
